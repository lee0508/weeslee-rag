...
TARGET_PROJECTS: dict[str, dict] = {
    ...
    "72. LH 스마트시티플랫폼": {
        "slug": "lh-smart-city",
        "display_name": "LH 스마트시티플랫폼 구축",
        "organization": "한국토지주택공사 (LH)",
        "year": "-",
        "project_type": "ISP / 플랫폼 구축",
        "search_name": "LH 스마트시티플랫폼 구축 ISP 제안",
    },
    "61. 농정원 AGRIX": {
        "slug": "nongjeongwon-agrix",
        "display_name": "농정원 AGRIX 고도화",
        "organization": "농림수산식품교육문화정보원 (농정원)",
        "year": "-",
        "project_type": "ISP / 시스템 고도화",
        "search_name": "농정원 AGRIX 고도화 정보화 ISP",
    },
    "142. 차세대 보건의료빅데이터개방시스템 구축을 위한 ISP": {
        "slug": "health-bigdata-isp",
        "display_name": "차세대 보건의료 빅데이터 개방시스템 ISP",
        "organization": "보건복지부 / 건강보험심사평가원",
        "year": "-",
        "project_type": "ISP (정보화전략계획)",
        "search_name": "보건의료 빅데이터 개방시스템 ISP 차세대",
    },
    "202407. 범죄예방정책_거대언어모델 도입활용방안 연구": {
        "slug": "crime-prevention-llm",
        "display_name": "범죄예방정책 거대언어모델(LLM) 도입활용방안 연구",
        "organization": "법무부 / 범죄예방정책국",
        "year": "2024",
        "project_type": "연구사업 (AI/LLM 도입)",
        "search_name": "범죄예방 LLM 거대언어모델 도입활용 연구",
    },
    "191. 제3차 보건의료기술 종합정보시스템 중기 isp 수립": {
        "slug": "health-it-isp-3rd",
        "display_name": "제3차 보건의료기술 종합정보시스템 중기 ISP",
        "organization": "한국보건의료연구원 (NECA)",
        "year": "-",
        "project_type": "ISP (중기 정보화전략계획)",
        "search_name": "보건의료기술 종합정보시스템 중기 ISP 3차",
    },
    "149. 국토지리정보원": {
        "slug": "ngii",
        "display_name": "국토지리정보원 정보화전략계획",
        "organization": "국토교통부 국토지리정보원",
        "year": "-",
        "project_type": "ISP (정보화전략계획)",
        "search_name": "국토지리정보원 ISP 정보화전략 공간정보",
    },
    "112. 차세대 국립병원 정보시스템 구축을 위한 BPRISP": {
        "slug": "national-hospital-bprisp",
        "display_name": "차세대 국립병원 정보시스템 BPR/ISP",
        "organization": "보건복지부 / 국립병원",
        "year": "-",
        "project_type": "BPR/ISP (업무재설계/정보화전략)",
        "search_name": "국립병원 차세대 정보시스템 BPR ISP 구축",
    },
    "202305. AI 기반 지능형 진로교육정보망": {
        "slug": "ai-career-edu",
        "display_name": "AI 기반 지능형 진로교육정보망 구축",
        "organization": "교육부 / 한국직업능력연구원",
        "year": "2023",
        "project_type": "ISP / AI 기반 서비스 구축",
        "search_name": "AI 지능형 진로교육정보망 구축 ISP",
    },
    "201703. 통계청 통계지리정보서비스 ISP": {
        "slug": "statistics-geo-isp",
        "display_name": "통계청 통계지리정보서비스 ISP",
        "organization": "통계청",
        "year": "2017",
        "project_type": "ISP (정보화전략계획)",
        "search_name": "통계청 통계지리정보서비스 ISP GIS",
    },
    "215. K-water 데이터허브": {
        "slug": "k-water-datahub",
        "display_name": "K-water 데이터허브 시스템",
        "organization": "한국수자원공사 (k-water)",
        "year": "-",
        "project_type": "데이터 플랫폼 구축",
        "search_name": "K-water 데이터허브 플랫폼 시스템 구축",
    },
    "202503. AX 활용 정보화전략계획수립_서울주택도시개발공사": {
        "slug": "sh-ax-isp",
        "display_name": "서울주택도시개발공사 AX 활용 정보화전략계획",
        "organization": "서울주택도시개발공사 (SH공사)",
        "year": "2025",
        "project_type": "ISP (AI전환/정보화전략계획)",
        "search_name": "서울주택도시 SH공사 AX AI전환 정보화전략계획 ISP",
    },
}
