...
_EXPANSIONS: dict[str, list[str]] = {
    ...
    "rfp": ["01. RFP", "제안요청서", "과업지시서"],
    "제안서": ["02. 제안서", "proposal", "전략및방법론", "기술및기능"],
    "산출물": ["03. 산출물", "deliverable", "현황분석", "이행계획"],
    "전략및방법론": ["01. 전략및방법론", "방법론", "strategy"],
    "기술및기능": ["02. 기술및기능", "기술", "기능"],
    "프로젝트관리": ["03. 프로젝트관리", "pm", "project management"],
    "프로젝트지원": ["04. 프로젝트지원", "support"],
    "환경분석": ["01. 환경분석", "환경", "분석"],
    "현황분석": ["02. 현황분석", "as-is", "현황"],
    "목표모델": ["03. 목표모델", "to-be", "목표"],
    "이행계획": ["04. 이행계획", "로드맵", "추진계획"],
    # 전략/계획 관련
